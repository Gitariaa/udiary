                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-body">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control shadow-sm" id="title" name="title" placeholder="Masukkan judul pantun..." required>
                                </div>
                        
                                <div class="form-group mb-4">
                                    <label for="theme" class="form-label">Theme<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control shadow-sm" id="theme" name="theme" placeholder="Masukkan tema pantun..." required>
                                </div>
                                ...
                                <div class="d-flex justify-content-around">
                                    ...
                                    <a href="{{ route('pantuns.index') }}" class="btn btn-primary rounded-pill shadow-lg"> Cancel </a>
                                    <a href="{{ route('pantuns.index') }}" class="btn btn-secondary rounded-pill shadow-lg"> Back </a>
                                </div> 
                            </div>
                        </div>
                    </form>
