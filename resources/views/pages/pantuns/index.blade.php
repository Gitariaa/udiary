            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1>UpantuN</h1>
                            <p class="mb-0">"The first two lines of a pantun often set up a theme or image, while the
                                second two lines provide a surprising twist or deeper meaning."</p>
                            <p> Dua baris pertama pantun sering kali menetapkan tema atau citra, sedangkan dua baris
                                berikutnya memberikan kejutan atau makna yang lebih dalam.</p>
                        </div>
                    </div>
                </div>
            </div>
