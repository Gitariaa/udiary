            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1>UpoetrY</h1>
                            <p class="mb-0">"The beauty of poetry lies in its ability to capture complex human
                                experiences in just a few carefully chosen words."</p>
                            <p> Keindahan puisi terletak pada kemampuannya untuk menangkap pengalaman manusia yang
                                kompleks hanya dengan beberapa kata yang dipilih dengan hati-hati.</p>
                        </div>
                    </div>
                </div>
            </div>
            <nav class="breadcrumbs">
                <div class="container">
                    <ol>
                        ...
                        <li class="current"><a href="{{ url('/poetries') }}">UpoetrY</a></li>
                    </ol>
                </div>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section id="blog-posts" class="blog-posts section">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    {{-- Pengecekan jika tidak ada puisi --}}
                    @if ($poetries->isEmpty())
                        <div class="alert alert-warning text-center">
                            Maaf, UpoetrY yang anda cari tidak ada😭.
                        </div>
                    @else
