                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="card mb-4 shadow-sm border-0">
                                <div class="card-body bg-white rounded shadow-lg p-4">
                                    ...
                                    <div class="mb-4 text-center">
                                        <h5 class="text-uppercase fw-bold text-success">{{ $poems->title }}</h5>
                                        <small class="text-muted">Posted by: {{ $poems->user->name }} | Theme: {{ $poems->theme }}</small>
                                    </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('poems.index') }}" class="btn btn-outline-secondary rounded-pill shadow-lg">
                                    <i class="bi bi-arrow-left-circle"></i> Back
                                </a>
    
                                <div class="d-flex">
                                    @if (Auth::check() && (Auth::user()->role == 'admin' || Auth::user()->id == $poems->user_id))
