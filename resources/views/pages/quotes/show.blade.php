            ...
            <div class="card shadow-sm border-0">
                <div class="card-body bg-light">
                            ...
                            <div class="card mb-4 shadow-sm border-0">
                                <div class="card-body bg-white rounded shadow-lg p-4">
                                    ...
                                    <div class="mb-4 text-center">
                                        ...
                                        <small class="text-muted">Posted by: {{ $quotes->user->name }} | Theme:
                                            {{ $quotes->theme }}</small>
                                    </div>
                                    ...
                                    <div class="text-end">
                                        <small class="text-muted">Created at:
                                            {{ $quotes->created_at->format('d M, Y') }}</small><br>
                                        <small class="text-muted">Updated at:
                                            {{ $quotes->updated_at->format('d M, Y') }}</small><br>
                                        @if ($quotes->edited_by)
                    ...
                    <div class="mt-5">
                        ...
                        <!-- Display Comments -->
                        @foreach ($quotes->comments as $comment)
                        ...
                        @auth
                            <form action="{{ route('comments.store') }}" method="POST">
                                @csrf
                                <input type="hidden" name="commentable_type" value="App\Models\Quote">
                                <input type="hidden" name="commentable_id" value="{{ $quotes->id }}">
