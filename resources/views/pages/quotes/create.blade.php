                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-around">
                                    ...
                                    <button type="submit" class="btn btn-outline-success rounded-pill shadow-lg"><i class="class bi bi-send"></i> Save </button>
                                    <a href="{{ route('quotes.index') }}" class="btn btn-outline-secondary rounded-pill shadow-lg"><i class="bi bi-arrow-right-circle"></i> Back </a>
                                </div> 
                            </div>
                        </div>
                    </form>
